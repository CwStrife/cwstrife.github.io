...
.control-top-row{display:grid;grid-template-columns:minmax(0,1fr) auto auto;align-items:center;gap:8px;padding-bottom:8px;border-bottom:1px solid rgba(255,255,255,.04);margin-bottom:10px}
...
.kiosk-note{
  ...
  background:linear-gradient(180deg, rgba(29,63,99,.82), rgba(15,31,50,.88));
...
.fish-modal{
  ...
  display:flex;flex-direction:column;
  border-radius:34px;background:linear-gradient(180deg, rgba(17,39,62,.99), rgba(9,20,31,.995));
...
.modal-close{
  ...
  display:grid;place-items:center;cursor:pointer;background:linear-gradient(180deg,#1b3b59,#0f2436);
...
.modal-photo-card{overflow:hidden;background:linear-gradient(180deg, rgba(25,51,79,.86), rgba(12,25,39,.96))}
.modal-photo{
  position:relative;height:450px;background:linear-gradient(135deg,#1a3a58,#0b1d2d);overflow:hidden
}
.modal-photo img{width:100%;height:100%;object-fit:cover}
.modal-photo::after{
  content:"";position:absolute;left:0;right:0;bottom:0;height:48%;
  background:linear-gradient(180deg, transparent, rgba(7,17,27,.88))
}
...
.modal-stat{
  padding:18px 18px 16px;background:linear-gradient(180deg, rgba(27,54,84,.90), rgba(12,25,39,.96))
}
...
.modal-section{
  padding:18px 18px 20px;background:linear-gradient(180deg, rgba(20,40,63,.90), rgba(11,23,36,.96))
}
.modal-section.ocean{background:linear-gradient(180deg, rgba(21,47,74,.94), rgba(11,24,39,.97))}
...
.reading-block{
  padding:16px 16px;border-radius:22px;background:linear-gradient(180deg, rgba(10,22,36,.54), rgba(7,15,24,.66));
...
.list-pill{
  padding:11px 13px;border-radius:999px;background:linear-gradient(180deg, rgba(29,57,86,.94), rgba(15,29,45,.98));
  border:1px solid rgba(200,232,255,.12);font-size:15px;font-weight:900;color:#f4fbff
}
.fact-stack{display:grid;gap:12px}
.fact-card{
  padding:16px 17px;background:linear-gradient(180deg, rgba(21,45,71,.94), rgba(12,24,37,.97));
...
.toast{
  ...
  background:rgba(7,17,27,.95);border:1px solid rgba(152,224,255,.20);color:#f7fcff;border-radius:999px;padding:13px 18px;
  font-weight:900;box-shadow:var(--shadow);transition:.24s ease;z-index:80
}
...
@media (max-width:600px) and (pointer:coarse){
  ...
  .modal-close{
    ...
    background:rgba(10,22,36,.85)!important;backdrop-filter:blur(8px);
  }
...
.folder-tab.active::before,.inventory-chip-filter.is-active::before,.mode-btn.active::after,.status-pill::after,.mini-pill::after,.tank-pill::after{animation:waterlineSweep 5.8s cubic-bezier(.22,.8,.2,1) infinite}
.status-pill::after,.mini-pill::after,.tank-pill::after{background:linear-gradient(115deg, rgba(255,255,255,0) 0%, rgba(255,255,255,.18) 42%, rgba(255,255,255,0) 70%);transform:translateX(-120%)}
/* === WATER PARAMETERS === */
...
.input-modal{
  width:90%;max-width:440px;padding:28px;border-radius:24px;
  background:linear-gradient(180deg,rgba(22,28,38,.98),rgba(14,18,26,.99));
  border:1px solid rgba(255,255,255,.08);box-shadow:0 30px 80px rgba(0,0,0,.4);
  animation:modalSlideIn .25s ease-out;
}
.input-modal h3{margin:0 0 6px;font-size:20px;font-weight:800}
.input-modal .modal-desc{font-size:13px;color:rgba(255,255,255,.4);margin-bottom:18px}
.input-modal-field{margin-bottom:12px}
.input-modal-field label{display:block;font-size:11px;font-weight:800;letter-spacing:.1em;text-transform:uppercase;color:rgba(255,255,255,.35);margin-bottom:5px}
.input-modal-field input,.input-modal-field select,.input-modal-field textarea{
  width:100%;padding:12px 14px;border-radius:12px;border:1px solid rgba(255,255,255,.12);
  background:rgba(255,255,255,.06);color:#fff;font-size:16px;font-weight:700;font-family:inherit;
}
.input-modal-field input:focus,.input-modal-field textarea:focus{border-color:rgba(90,220,200,.4);outline:none}
.input-modal-field input::placeholder{color:rgba(255,255,255,.25)}
.input-modal-actions{display:flex;gap:10px;margin-top:18px}
.input-modal-actions button{
  flex:1;padding:12px;border-radius:12px;font-size:14px;font-weight:800;cursor:pointer;
}
.input-modal-actions .btn-confirm{
  background:rgba(90,220,200,.15);border:1px solid rgba(90,220,200,.3);color:#5eebc8;
}
.input-modal-actions .btn-confirm:hover{background:rgba(90,220,200,.25)}
...
.mode-btn.active::after{
  content:'';position:absolute;inset:0;border-radius:inherit;
  background:linear-gradient(110deg,transparent 0%,transparent 38%,rgba(255,255,255,.18) 50%,transparent 62%,transparent 100%);
  transform:translateX(-120%);
  animation:modeSweep 4.2s linear infinite;
  pointer-events:none;
}
...
@media (max-width:600px) and (pointer:coarse){
  ...
  .fish-modal.mobile-safe .modal-layout.mobile-stack{
    display:grid!important;grid-template-columns:1fr!important;gap:10px;padding-bottom:6px;align-content:start;
  }
  .fish-modal.mobile-safe .modal-layout.mobile-stack > *{min-width:0}
  .fish-modal.mobile-safe .modal-photo{height:min(42dvh,300px)!important;min-height:220px}
  .fish-modal.mobile-safe .modal-photo-copy h2{font-size:clamp(24px,7vw,34px)!important;line-height:1.02}
  .fish-modal.mobile-safe .modal-photo-copy .latin{font-size:14px!important;margin-top:6px}
  .fish-modal.mobile-safe .modal-mini{gap:6px}
  .fish-modal.mobile-safe .mini-pill{font-size:11px!important;padding:6px 8px!important;max-width:100%;overflow:hidden;text-overflow:ellipsis}
  .fish-modal.mobile-safe .mobile-stat-grid{display:grid;grid-template-columns:1fr 1fr;gap:8px}
  .fish-modal.mobile-safe .modal-stat{padding:12px 12px 10px;border-radius:16px}
  .fish-modal.mobile-safe .modal-stat .meta-value{font-size:20px;line-height:1.2}
  .fish-modal.mobile-safe .modal-stat .meta-sub{display:none}
  .fish-modal.mobile-safe .modal-section,
  .fish-modal.mobile-safe .origin-card,
  .fish-modal.mobile-safe .staff-card{padding:12px 12px 14px;border-radius:16px;min-width:0}
  .fish-modal.mobile-safe .section-title h3{font-size:11px;letter-spacing:.14em}
  .fish-modal.mobile-safe .overview,
  .fish-modal.mobile-safe .reading-block p,
  .fish-modal.mobile-safe .origin-card p,
  .fish-modal.mobile-safe .staff-card p,
  .fish-modal.mobile-safe .fact-card{font-size:14px!important;line-height:1.55!important}
  .fish-modal.mobile-safe .reading-block{padding:12px;border-radius:14px}
  .fish-modal.mobile-safe .reading-block strong{font-size:11px;letter-spacing:.11em}
  .fish-modal.mobile-safe .gauge-head strong{font-size:14px}
  .fish-modal.mobile-safe .gauge-head span{font-size:12px}
  .fish-modal.mobile-safe .gauge-track{height:14px}
  .fish-modal.mobile-safe .gauge-marker{width:20px;height:20px;border-width:4px}
  .fish-modal.mobile-safe .gauge-scale{font-size:10px;margin-top:8px}
  .fish-modal.mobile-safe .two-col,
  .fish-modal.mobile-safe .mobile-two-col{grid-template-columns:1fr!important;gap:10px}
  .fish-modal.mobile-safe .pill-list{gap:6px}
  .fish-modal.mobile-safe .list-pill{font-size:11px;padding:7px 9px;white-space:normal;overflow-wrap:anywhere}
  .fish-modal.mobile-safe .photo-gallery{display:grid;grid-template-columns:repeat(auto-fit,minmax(72px,1fr));gap:8px;overflow:visible;padding:0}
  .fish-modal.mobile-safe .photo-gallery-thumb,
  .fish-modal.mobile-safe .photo-gallery-upload{width:100%;height:64px;flex:none}
  .fish-modal.mobile-safe .photo-upload-row{padding-top:4px}
  .fish-modal.mobile-safe .photo-gallery-upload-wide{width:100%;height:auto;padding:10px 12px}
  .fish-modal.mobile-safe .similar-row.mobile-similar-grid{display:grid;grid-template-columns:1fr 1fr;gap:8px;overflow:visible;padding-bottom:0}
  .fish-modal.mobile-safe .action-row{gap:8px}
  .fish-modal.mobile-safe .cta{min-height:46px;padding:0 14px;border-radius:14px;font-size:13px;flex:1 1 100%}
...
@media (max-width:600px) and (pointer:coarse){
  ...
  .mobile-fact{padding:7px 8px;border-radius:10px;background:linear-gradient(180deg,rgba(24,32,44,.92),rgba(14,20,28,.96));border:1px solid rgba(255,255,255,.06);min-width:0}
...
.view-toggle-wrap{
  ...
  padding:4px;
  border-radius:16px;
  background:linear-gradient(180deg,rgba(16,32,52,.94),rgba(9,18,30,.98));
...
@media (min-width:861px){
  ...
  .cards.compact-mode .mobile-fact{
    padding:6px 7px;
    border-radius:10px;
    background:linear-gradient(180deg,rgba(22,30,42,.92),rgba(14,20,28,.96));
    border:1px solid rgba(255,255,255,.06);
    min-width:0;
  }
...
.modal-headline-bar{display:flex;align-items:flex-start;gap:12px;padding:12px 14px;border-radius:18px;border:1px solid rgba(152,224,255,.18);background:linear-gradient(180deg, rgba(31,64,95,.78), rgba(12,24,37,.88));box-shadow:var(--shadow-soft)}
...
.similar-card{position:relative;overflow:hidden;min-width:160px;height:132px;padding:0;border-radius:20px;border:1px solid rgba(200,232,255,.12);background:#102233;box-shadow:var(--shadow-soft)}
.similar-photo{position:absolute;inset:0;background:linear-gradient(135deg,#173655,#0d1b2b)}
...
.similar-card:hover{transform:translateY(-1px);background:#102233;border-color:rgba(255,255,255,.18)}
...
.food-card{padding:12px 14px;border-radius:16px;background:linear-gradient(180deg,rgba(17,39,57,.92),rgba(10,20,30,.96));border:1px solid rgba(160,224,255,.14);box-shadow:var(--shadow-soft)}
...
.food-card-toggle{display:block;padding:12px 14px;border-radius:16px;background:linear-gradient(180deg,rgba(17,39,57,.92),rgba(10,20,30,.96));border:1px solid rgba(160,224,255,.14);cursor:pointer;min-height:120px}
...
.food-advice-card{padding:14px 15px;border-radius:16px;background:linear-gradient(180deg,rgba(11,28,42,.9),rgba(7,18,28,.98));border:1px solid rgba(144,214,255,.12)}
...
.inventory-search,.inventory-filter{width:100%;padding:12px 14px;border-radius:12px;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.12);color:#fff;font-size:14px}
...
/* === V0.072 rollback persistence + modal hero polish + dark selects === */
...
.input-modal-field select{
  ...
  background-image:linear-gradient(180deg, rgba(16,34,53,.96), rgba(9,18,29,.96));
}
...
.modal-hero-shell{
  ...
  background:linear-gradient(180deg, rgba(10,22,35,.92), rgba(7,15,24,.96));
  box-shadow:var(--shadow-soft);
}
...
.modal-layout.mobile-stack .modal-hero-shell{
  ...
  background:linear-gradient(180deg, rgba(9,22,35,.92), rgba(7,17,27,.98));
  box-shadow:var(--shadow-soft);
}
.modal-layout.mobile-stack .modal-hero-shell{
...
.inventory-search,.inventory-filter{color-scheme:dark;background:linear-gradient(180deg,rgba(15,31,48,.96),rgba(9,18,29,.96));border-color:rgba(160,210,255,.16);box-shadow:inset 0 1px 0 rgba(255,255,255,.04)}
.inventory-filter option,.inventory-filter optgroup,.input-modal-field select option,.input-modal-field select optgroup{background:#102235;color:#f4fbff}
.inventory-quickbar{display:flex;gap:8px;overflow-x:auto;padding:2px 0 14px;margin:-4px 0 6px;scrollbar-width:thin}
.inventory-chip-filter{display:inline-flex;align-items:center;gap:8px;flex:0 0 auto;padding:10px 12px;border-radius:999px;border:1px solid rgba(160,210,255,.14);background:rgba(255,255,255,.05);color:#eef8ff;font-size:12px;font-weight:700;cursor:pointer;transition:transform .16s ease,border-color .16s ease,background .16s ease}
...
.inventory-chip-filter:hover{transform:translateY(-1px);border-color:rgba(90,220,200,.35)}
.inventory-chip-filter.is-active{background:rgba(90,220,200,.15);border-color:rgba(90,220,200,.36);color:#84f5de}
...
.input-choice-btn{padding:8px 10px;border-radius:10px;border:1px solid rgba(160,210,255,.16);background:rgba(255,255,255,.05);color:#eef8ff;font-size:12px;font-weight:700;cursor:pointer;transition:transform .16s ease,border-color .16s ease,background .16s ease}
